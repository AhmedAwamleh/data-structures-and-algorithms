...
const countNumberOfElements = (arr) => {
  let count = arr.reduce((previousValue) => {
...
const returnNames = (arr) => {
  let names = arr.reduce((previousValue, currentValue) => [...previousValue, currentValue.name],
    []
  );
  return names;
};
...
const countNumberOfChildren = (arr) => {
  let count = 0;
  let children = arr.reduce((_previousValue, currentValue) => {
