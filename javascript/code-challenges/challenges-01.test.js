...
const createList = (availableItems) => {
  ...
  availableItems.forEach(element => {
    element.available? newArr.push(element.name): 0;
  });
  return newArr;
};
...
const fizzbuzz = (arr) => {
  const newArr=[];
  arr.forEach(v =>{
    (v%5 === 0 && v%3 === 0) ? newArr.push('Fizz Buzz') : (v%5 === 0) ? newArr.push('Buzz') :
      (v%3 === 0) ? newArr.push('Fizz'):newArr.push(v);
  });
  return newArr;
};
/* ------------------------------------------------------------------------------------------------
